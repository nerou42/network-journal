...
## [Unreleased](https://github.com/nerou42/network-journal/compare/v0.7.2...HEAD)
...
- Backwards compatibility to <0.7.0


## [0.7.1](https://github.com/nerou42/network-journal/compare/v0.7.0...v0.7.1) - 2026-07-09

### Added

- Config parameter to set the IMAP polling interval
- Config parameter to set the TLS certificate check interval
...
- TLS certificate validity (expiration, revocation) check
- `include_subdomains` option to filter config


## [0.5.3](https://github.com/nerou42/network-journal/compare/v0.5.2...v0.5.3) - 2025-12-06
